...
public final class TransferClaimCommand implements CommandExecutor, TabCompleter
{
     ...
     */
    public TransferClaimCommand(final GriefPrevention plugin)
    {
        // set reference to main class
        this.plugin = plugin;

        // register this class as command executor
        Objects.requireNonNull(plugin.getCommand("transferclaim")).setExecutor(this);
    }
