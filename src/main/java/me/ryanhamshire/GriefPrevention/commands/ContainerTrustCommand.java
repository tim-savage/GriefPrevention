...
public final class ContainerTrustCommand implements CommandExecutor, TabCompleter
{
    ...
    public ContainerTrustCommand(final GriefPrevention plugin)
    {
        ...
        Objects.requireNonNull(plugin.getCommand("containertrust")).setExecutor(this);
    }
