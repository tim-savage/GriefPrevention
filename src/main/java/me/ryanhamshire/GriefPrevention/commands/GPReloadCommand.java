...
public final class GPReloadCommand implements CommandExecutor
{
    ...
    public boolean onCommand(@NotNull final CommandSender sender, @NotNull final Command command, @NotNull final String s, @NotNull final String[] args)
    {
        ...
        plugin.loadConfig();
        GriefPrevention.sendMessage(sender, TextMode.Success, "Configuration updated.  If you have updated your Grief Prevention JAR, you still need to /reload or reboot your server.");
        return true;
    }
}
